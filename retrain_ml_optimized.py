...
def main():
    ...
    print("=" * 80)
    print("\n💡 Улучшения:")
    print("  1. Более агрессивный таргет: movement > 1% за 5 свечей (75 минут)")
    print("  2. Балансировка классов: LONG/SHORT в 3x приоритете vs HOLD")
    print("  3. Больше данных: 30 дней истории")
    print("  4. Оптимизированные гиперпараметры XGBoost + RandomForest")
    print("\n🎯 Ожидаемый результат: 50-100 сигналов за 7 дней (вместо 19)")
    print("=" * 80)
    ...
    symbols = ["SOLUSDT", "BTCUSDT", "ETHUSDT"]  # SOLUSDT первым - он активнее
